...
/**
 * Compiles JavaScript file to .bin file.
 ...
 * @param   {string}          [args.output=filename.bin] The output filename. Defaults to the same path and name of the original file, but with `.bin` extension.
...
/**
 * Runs .bin file and returns the result.
...
/**
 * Add a loader file for a given .bin file
 * @param {String} fileToLoad path of the .bin file we're loading
 * @param {String} loaderFilename - optional pattern or name of the file to write - defaults to filename.loader.js. Patterns: "%" represents the root name of .bin file.
 */
const addLoaderFile = function (fileToLoad, loaderFilename) {
  ...
  if (typeof loaderFilename === 'boolean' || loaderFilename === undefined || loaderFilename === '') {
    loaderFilePath = fileToLoad.replace('.bin', '.loader.js');
  } else {
